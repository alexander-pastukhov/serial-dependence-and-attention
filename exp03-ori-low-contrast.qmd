...
Compiling models
```{r}
model_names <- c("bayesian_integration", "ubi_ur", "ubi_r", "ubi_re","ubi_re_ct", "ubi_re_cte", "ubi_re_ctr", "ubi_re_cter")
...
posterior_abs <- posterior_group_averages_from_mu("PosteriorAverages/exp3-absolute-ubi_re_ct.RDS", results, mu, Orientation, OriResponse, compute_average_absolute_response)
...
saveRDS(plot, file = glue("ParameterPlots/abs-posterior-prediction-exp03-ubi_re_ct.RDS"))
plot
ggsave("Figures/posterior-abs-exp03_ubi_re_ct.png", units = "cm", width = 16, height = 10)
ggsave("Figures/posterior-abs-exp03_ubi_re_ct.svg", units = "cm", width = 16, height = 10)
```
...
posterior_rel <- posterior_group_averages_from_mu("PosteriorAverages/exp3-relative--ubi_re_ct.RDS", results, mu, Orientation, OriResponse, compute_average_relative_response)
...
saveRDS(plot, file = glue("ParameterPlots/rel-posterior-prediction-exp03-ubi_re_ct.RDS"))
plot
ggsave("Figures/posterior-rel-exp03_ubi_re_ct.png", units = "cm", width = 16, height = 10)
ggsave("Figures/posterior-rel-exp03_ubi_re_ct.svg", units = "cm", width = 16, height = 10)
```
...
plot_parameter_distribution(draws, "exp03", "Beta Central Tendency", "mu_params[7]", "mu_params[8]")
```
